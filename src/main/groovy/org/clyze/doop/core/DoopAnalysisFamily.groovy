...
class DoopAnalysisFamily implements AnalysisFamily {
	...
	static final String ENGINE_SOUFFLE = 'souffle'
	static final String ENGINE_FLOWLOG = 'flowlog'
	...
	private static List<AnalysisOption<?>> SUPPORTED_OPTIONS = [
			...
			/* Datalog engine backend selection */
			new AnalysisOption<String>(
					id: "ENGINE",
					name: "engine",
					group: GROUP_ENGINE,
					description: "Datalog engine backend: 'souffle' (default) or 'flowlog'.",
					validValues: [ENGINE_SOUFFLE, ENGINE_FLOWLOG] as Set<String>,
					value: ENGINE_SOUFFLE,
					argName: "ENGINE"
			),
			...
			new IntegerAnalysisOption(
					...
					name: "flowlog-jobs",
					group: GROUP_ENGINE,
					description: "Worker threads for the FlowLog analysis binary (default: 64).",
					argName: "NUMBER",
					value: 64
			),
			new BooleanAnalysisOption(
					...
					name: "flowlog-sip",
					group: GROUP_ENGINE,
					description: "Enable Sideways Information Passing in the FlowLog engine."
			),
			new BooleanAnalysisOption(
					id: "FLOWLOG_PROFILE",
					name: "flowlog-profile",
					group: GROUP_ENGINE,
					description: "Collect per-rule execution statistics in the FlowLog engine."
			),
			new BooleanAnalysisOption(
					id: "FLOWLOG_SAVE_TEMPS",
					name: "flowlog-save-temps",
					group: GROUP_ENGINE,
					description: "Keep the Rust crate generated by flowlog-compiler instead of cleaning it up."
			),
			new BooleanAnalysisOption(
					id: "FLOWLOG_STR_INTERN",
					name: "flowlog-str-intern",
					group: GROUP_ENGINE,
					description: "Intern string columns in the FlowLog engine (required for Doop's ord(); on by default).",
					value: true
			),
